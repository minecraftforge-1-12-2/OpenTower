layer_depth_quiet("Tiles_BG", 200);
layer_depth_quiet("Tiles_BG2", 199);
layer_depth_quiet("Tiles_BG3", 198);
layer_depth_quiet("Tiles_1", 100);
layer_depth_quiet("Tiles_2", 98);
layer_depth_quiet("Tiles_3", 97);
layer_depth_quiet("Tiles_4", 96);
layer_depth_quiet("Tiles_Foreground1", 99);
layer_depth_quiet("Tiles_Foreground2", 98);
layer_depth_quiet("Tiles_Foreground3", 97);
layer_depth_quiet("Assets_BG", 201);
layer_depth_quiet("Assets_BG1", 201);
layer_depth_quiet("Assets_BG2", 202);
layer_depth_quiet("Assets_FG", -350);
layer_depth_quiet("Assets_FG1", -350);
layer_depth_quiet("Assets_FG2", -351);
...
layer_depth_quiet("Foreground_1", -400);
layer_depth_quiet("Foreground_Ground1", -401);
layer_depth_quiet("Backgrounds_Ground1", 250);

...
if sprite_index == spr_cheeseblock_falling && reset > 0
	reset--;
if (reset <= 0 && !place_meeting(xstart, ystart, obj_player1) && !place_meeting(xstart, ystart, obj_pizzaball) && !place_meeting(xstart, ystart, obj_clownmato) && !place_meeting(xstart, ystart, obj_monster))
{
	reset = 100;
